...
// Journalisation de l'accès à la page d'administration des tickets
$stmt = $bdd->prepare("INSERT INTO logs (user_id, action) VALUES (?, ?)");
$action = "Accès à la page d'administration des tickets";
...
<h1>Administration des tickets</h1>
...
<?php else: ?>
    <?php foreach ($tickets as $ticket): ?>
        <div class="ticket <?= strtolower(str_replace(' ', '_', $ticket['etat_libelle'])) ?>">
            ...
            <p><a href="3_2_consulter_ticket.php?id=<?= $ticket['id'] ?>">Modifier</a></p>
